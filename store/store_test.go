...
func TestPruningService(t *testing.T) {
	...
	require.Error(t, err)
	require.Equal(t, state.Validators.GetProposer().PubKey.Address(), state.Validators.GetProposer().Address)
	require.Equal(t, state.Validators.Validators[0].PubKey.Address(), state.Validators.Validators[0].Address)
